...
def main():
    print("==============================================")
    print(" DATABASE BST: MANAJEMEN NILAI MAHASISWA AN-25")
    print("==============================================")
    
    bst = BSTManajemenNilai()
    pilih = 0
    while pilih != 7:
        print("\n=== BST (Lanjutan) ===")
        print("1. Insert (Input Nilai Baru)")
        print("2. Delete (Hapus Nilai)")
        print("3. Level-order (Cetak Struktur Pohon per Level)")
        print("4. Height (Cek Kedalaman Tingkat Pohon)")
        print("5. Successor (Cari Nilai Di Atas Nilai X)")
        print("6. Predecessor (Cari Nilai Di Bawah Nilai X)")
        print("7. Keluar")
        try:
        ...
        if pilih == 1:
            try:
                ...
                bst.insert(x)
                print(f">> Data [{x}] sukses tersimpan di sistem.")
            except ValueError:
                print("Input tidak valid!")
        elif pilih == 2:
            try:
                ...
                bst.delete(x)
                print(f">> Data [{x}] sukses dibersihkan dari sistem.")
            except ValueError:
                print("Input tidak valid!")
        elif pilih == 3:
